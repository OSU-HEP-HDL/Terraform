source "proxmox-iso" "pkr-ubuntu-noble-1" {
  ...
  # this is deprecated and I have moved this config to the boot_iso block
  ...
  cloud_init                = true
  cloud_init_storage_pool   = "VM_Storage_Pool"

  boot_iso {
    iso_file = "NAS01:iso/ubuntu-24.04.1-live-server-amd64.iso"
    unmount = true
  ...
  boot_command = [
    ...
    "<down><down><down><end>",
    "<bs><bs><bs><bs><wait>",
    "ip=10.221.194.200::10.221.194.254:255.255.255.0::::139.78.100.1 ",
